 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Disability is a state of mind, not a state of body</h1>
            <p class="lead fw-normal text-white-50 mb-0">Products for Independent Living ... Shop Now!</p>
        </div>
    </div>
</header>
<!-- Section-->
